...
function getLanguageIcon(id) {
    switch (id) {
        ...
        case "C++": return "./images/icons/languages/CPP.png";
        case "C": return "./images/icons/languages/C.png";
        case "PYTHON": return "";
        ...
        case "THREE": return "./images/icons/languages/frameworks/THREE.png";
        default: return "";
    };
};
function loadMenu() {
